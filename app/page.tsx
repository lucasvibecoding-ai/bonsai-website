      ...
      <div className="bonsai-page">
        <div className="container">
          ...
          <section style={{ paddingTop: 64, paddingBottom: 48, textAlign: 'center' }}>
            ...
            <p className="hero-sub" style={{ color: 'var(--ink-muted)', marginTop: 8, maxWidth: 600, marginLeft: 'auto', marginRight: 'auto', fontStyle: 'italic' }}>Bonsai is the ancient art of sculpting miniature trees. Used for centuries to release stress, ease anxiety, and find focus.</p>
